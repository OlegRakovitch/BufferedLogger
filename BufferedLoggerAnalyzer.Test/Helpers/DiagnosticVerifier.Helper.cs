...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        //private static readonly MetadataReference BufferedAttributeReference = MetadataReference.CreateFromFile(typeof(BufferedAttribute).Assembly.Location);
        ...
        private static IEnumerable<MetadataReference> GetGlobalReferences()
        {
            ...
            references.Add(MetadataReference.CreateFromFile(typeof(BufferedAttribute).Assembly.Location));
            return references;
        }
        ...
        private static Project CreateProject(string[] sources, string language = LanguageNames.CSharp)
        {
            ...
            foreach(var reference in GetGlobalReferences())
            {
                ...
                //.AddMetadataReference(projectId, BufferedAttributeReference);
